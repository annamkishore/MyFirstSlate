...
//		board.setPenColor(color);
    ...
    /**
     * feature: save the drawing as image file
     *
     * @param content
     * @param forSharing
     */
    private void saveScreen(View content, boolean forSharing) {
        try {
            ...
            if( ! forSharing ) {
                Toast.makeText(this, "img saved at " + file.getAbsolutePath(), Toast.LENGTH_SHORT).show();
            }
        } catch (Exception e) {
            Toast.makeText(getBaseContext(), "Please insert SD card.", Toast.LENGTH_SHORT).show();
            e.printStackTrace();
        }
    }
                ...
                .setNeutralButton("Rate Us", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        try {
                            ...
                            Toast.makeText(MainActivity.this, "Unable to find Google Play.", Toast.LENGTH_SHORT).show();
                        }}}
                )
    ...
    class SlateListener implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
        ...
        public void onClick(View view) {
            ...
            ColorDialogFragment colorDlgFrag = new ColorDialogFragment();
            colorDlgFrag.setActivity(MainActivity.this);
